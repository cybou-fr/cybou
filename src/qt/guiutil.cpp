...
static std::string DummyAddress([[maybe_unused]] const CChainParams &params)
{
    std::string addr{"cyb1p35yvjel7srp783ztf8v6jdra7dhfzk5jaun8xz2qp6ws7z80n4tq2jku9f"};
    assert(!addr.empty());
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "CYBOU.lnk";
}

bool GetStartOnSystemStartup()
{
    // Check the isolated CYBOU startup shortcut.
