...
void RPCNestedTests::rpcNestedTests()
{
    ...
    // CYBOU development genesis coinbase transaction id (see CChainParams::Main).
    QVERIFY(result == "a1cc066afc59f4a9b219a94f5e185772260ac1af43a4508bfc06acc61da91cb2");
