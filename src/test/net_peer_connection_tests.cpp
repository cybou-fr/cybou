...
BOOST_FIXTURE_TEST_CASE(test_addnode_getaddednodeinfo_and_connection_detection, PeerTest)
{
    ...
    {
        ASSERT_DEBUG_LOG("Added connection to 127.0.0.1:29444 peer=1");
    ...
    for (int i = 0; i < 10; ++i) {
        ASSERT_DEBUG_LOG("Not opening a connection to localhost, already connected to 127.0.0.1:29444");
