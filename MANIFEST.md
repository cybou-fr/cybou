...
| `docs/cybou\22_ROADMAP.md` | 123 | `104873068bb37ab7` |
| `docs/cybou\23_MANUAL_ACCEPTANCE.md` | 82 | `f2aa303209b24341` |
| `docs/cybou\24_DECISIONS.md` | 161 | `29ba7ed43c9e5cbb` |
...
| `docs/cybou\68_OPERATOR_KEY_SEPARATION.md` | 84 | `ab3e578153540928` |
...
| `spec\cybou_baseline.yaml` | 254 | `c73e73fe2e488a8f` |
...
| `spec\operator_keys.yaml` | 44 | `2b76c667a8029387` |
