# CYBOU documentation manifest — 2026-09-24

This inventory records the current documentation and specification files,
excluding this manifest. SHA-256 prefixes are computed from UTF-8 file bytes
after normalizing CRLF to LF, so Windows and Unix checkouts agree.
Line counts use normalized text lines. Regenerate the inventory after
editing an included file.

Frozen implementation rules are in `AGENTS.md` and protocol decisions in
`docs/cybou/24_DECISIONS.md`. `docs/cybou/26_IMPLEMENTATION_STATUS.md`
distinguishes implemented DEV code from production targets.
...
| docs/cybou/10_IDENTITY_NAMES.md | 74 | ee0a175ee6bd089c |
...
| docs/cybou/14_BACKUP.md | 60 | 49b0da9f7017a777 |
| docs/cybou/15_DRIVE.md | 36 | 7964e6d24f3bcf91 |
...
| docs/cybou/26_IMPLEMENTATION_STATUS.md | 274 | ca47f37848f00ec4 |
...
| docs/cybou/53_TRUST_AND_NETWORK_LIMITS.md | 66 | ed978197c3ba0c7c |
...
| docs/cybou/57_GLOBAL_PROOF_OF_TRUST_POLICY.md | 60 | 58f313f629d9a8d1 |
...
| docs/cybou/63_MAIL_STATE_GROWTH_AND_DISCOVERY.md | 92 | 0a0c7a356eeb89ba |
...
| docs/cybou/76_IDENTITY_VAULT_RECOVERY.md | 67 | 5418bd24459fa210 |
